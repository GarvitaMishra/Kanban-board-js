...
A simple Kanban-style task management board built using HTML, CSS, and JavaScript.
This project allows users to create, organize, and manage tasks across different stages of completion using a drag-and-drop interface.
...
Edit task title by double-clicking the task
